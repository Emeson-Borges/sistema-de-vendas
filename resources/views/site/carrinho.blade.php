...
<div class="row container"> 
    ...
    @else
      ...
      <table class="striped">
        ...
        <tbody>
          ...
          <tr>
            <td><img src="{{ $item->attributes->image }}" alt="" width="70" class="responsive-img cirlce"></td>
            <td>{{ $item->name }}</td>
          ...
          <form action="{{ route('site.atualizacarrinho')}}" method="POST" enctype="multipart/form-data">
            @csrf 
              ...
              <td><input style="width: 40px font-weight" class="white center" min="1" type="number" name="quantity" value="{{ $item->quantity }}"></td>
              <td>
  ...
  <div class="row container center">
    ...
    <a href="{{ route('site.limparcarrinho') }}" class="btn waves-effect waves-light red">Limpar carrinho<i class="material-icons">clear</i></a>
